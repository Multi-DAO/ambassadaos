...
COUNCIL='["croncat.'$DAO_ROOT_ACC'", "cheddar.'$DAO_ROOT_ACC'", "codame.'$DAO_ROOT_ACC'", "ref-finance.'$DAO_ROOT_ACC'", "marmaj.'$DAO_ROOT_ACC'", "openshards.'$DAO_ROOT_ACC'", "collabs.'$DAO_ROOT_ACC'", "auroradao.'$DAO_ROOT_ACC'", "move.'$DAO_ROOT_ACC'", "creatives.'$DAO_ROOT_ACC'", "growth-guild.'$DAO_ROOT_ACC'", "pixeltoken.'$DAO_ROOT_ACC'"]'
